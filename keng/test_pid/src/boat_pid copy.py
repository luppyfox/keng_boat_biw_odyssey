...
class R_PID(object): 
    def __init__(self, init_setPoint_value, init_state):
        ...
        self._setpoint_pub = rospy.Publisher("/r_setpoint", Float64, queue_size=1)
        self._state_pub = rospy.Publisher("/r_state", Float64, queue_size=1)       
    ...
    def setpoint_update(self, value):
        self._setpoint_pub.publish(value)

    def state_update(self, value):
        self._state_pub.publish(value)
...
class L_PID(object): 
    def __init__(self, init_setPoint_value, init_state):
        ...
        self._setpoint_pub = rospy.Publisher("/l_setpoint", Float64, queue_size=1)
        self._state_pub = rospy.Publisher("/l_state", Float64, queue_size=1)       
